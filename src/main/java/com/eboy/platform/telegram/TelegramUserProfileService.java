...
@Service
public class TelegramUserProfileService implements UserProfileService {

    private final static Logger logger = Logger.getLogger(TelegramUserProfileService.class.getName());
    ...
    @Autowired
    public TelegramUserProfileService(RestTemplate restTemplate) {
